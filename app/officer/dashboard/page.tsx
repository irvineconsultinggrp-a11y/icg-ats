...
// --- Pipeline & quick-action config (counts will come from real data) ---

const PIPELINE = [
  { stage: "Applications",    count: 0, href: "/officer/dashboard/applications",   icon: <FileTextIcon />,    color: "text-violet-600", bg: "bg-violet-50",  border: "border-violet-200" },
  { stage: "Group Interview", count: 0, href: "/officer/dashboard/group-interview", icon: <UsersIcon />,       color: "text-blue-600",   bg: "bg-blue-50",    border: "border-blue-200" },
  { stage: "Coffee Chats",    count: 0, href: "/officer/dashboard/coffee-chats",    icon: <CoffeeIcon />,      color: "text-amber-600",  bg: "bg-amber-50",   border: "border-amber-200" },
  { stage: "Decisions",       count: 0, href: "/officer/dashboard/decisions",       icon: <CheckSquareIcon />, color: "text-green-600",  bg: "bg-green-50",   border: "border-green-200" },
];
